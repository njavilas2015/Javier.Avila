<?php 
   require_once("conexion.php");
    ...
    $stmt = $conn->prepare("SELECT * FROM tb_camaras ");
                                    ...
                                    <div class="col-xs-9">
                                        <table width="100%" class="table" id="dataTables-example">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Tipo</th> <td>'.$data3.'</td>
                                                    <th>Alimentacíon</th> <td>'.$data4.'</td>
                                                </tr>
                                                <tr>
    ...
    }else {echo 'No existe registros. Si desea agregar un nuevo registro &nbsp <i class="fa fa-hand-o-right fa-fw"></i> &nbsp <button type="button"  class="btn btn-success btn-sm" data-toggle="modal" data-target="#new-camara" ><i class="fa fa-plus fa-fw"></i>Agregar nuevo</button>';}
